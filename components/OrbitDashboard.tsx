        ...
        <header className="sticky top-0 z-40 border-b border-white/10 bg-[#070a10]/95 backdrop-blur">
          <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                className="rounded-md border border-white/15 px-3 py-2 text-xs font-semibold text-white/80 hover:border-red-400/50 hover:text-red-200"
                onClick={async () => {
                  await fetch("/api/orbit/login", { method: "DELETE", credentials: "include" });
